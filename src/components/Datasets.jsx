      ...
      <div>
        <div className="sideBar desktop">
          <div className="greenBackground">
            <h1>What's this?</h1>
            <p>All data sets consist of power or energy related data that fall into the following 3 categories:</p>
            <dl>
              <dt>
                Live Data
              </dt>
              <dd>
                This is data that is provided by the platform and/or associated assets in an instantaneous fashion in a real-time or near real-time.
              </dd>
              ...
              <dd>
                Raw data consist of a data set for a specific period from the platform and/or associated assets that has no verification or additional data governance processes applied.
              </dd>
              ...
              <dd>
                This data set consists of data for a specific period from the platform and/or associated assets that have a verification or data governance process applied to the data.

              </dd>
            </dl>
            <p>Some data sets may contain user data such as user preferences or utilisation information.  Each data set will contain one or more of the above categories with nuances specific to each data set detailed below.
            </p>
          </div>
        </div>
